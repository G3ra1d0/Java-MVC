...
public class ProdutoTela extends javax.swing.JFrame {
    ...
    private void SalvarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SalvarMouseClicked
        if (Nome.getText().length() > 3 && Preco.getText().length() >= 3) {
    ...
    private void jButton5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton5MouseClicked
        String[][] matriz = this.controle.recuperarTodos();
        Codigo.setText(matriz[matriz.length - 1][0]);
        Nome.setText(matriz[matriz.length - 1][1]);
        Preco.setText(matriz[matriz.length - 1][2]);
        Unidade.setText(matriz[matriz.length - 1][3]);
        /// Ativa e desativa botoes
        Novo.setEnabled(false);
        Excluir.setEnabled(true);
        Salvar.setEnabled(true);
